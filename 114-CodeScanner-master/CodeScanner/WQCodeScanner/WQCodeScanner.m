...
@interface WQCodeScanner ()<AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
- (void)loadCustomView {
    ...
    [imageBtn setBackgroundImage:[UIImage imageNamed:@"album"] forState:UIControlStateNormal];
    [imageBtn setTitle:@"3333" forState:UIControlStateNormal];
    [self.view addSubview:imageBtn];
    imageBtn.frame = CGRectMake(100, 100, 44, 44);
    [imageBtn addTarget:self action:@selector(presentImagePickerController) forControlEvents:UIControlEventTouchUpInside];
