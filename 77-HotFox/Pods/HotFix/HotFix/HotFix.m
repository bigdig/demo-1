...
- (id)runClassWithClassName:(NSString *)className selector:(NSString *)selector obj1:(id)obj1 obj2:(id)obj2 {
    ...
    NSLog(@" 类:%@,方法:%@,参数1:%@,参数2:%@",klass,selector,obj1,obj2);
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
    id target =  [klass performSelector:NSSelectorFromString(selector) withObject:obj1 withObject:obj2];
    
    if (target) {
        //        NSLog(@" 返回值:%@",target);
        [self.cache addObject:target];
...
- (id)runInstanceWithInstance:(id)instance selector:(NSString *)selector obj1:(id)obj1 obj2:(id)obj2 {
    ...
    NSLog(@" 对象:%@,方法:%@,参数1:%@,参数2:%@",instance,selector,obj1,obj2);
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
